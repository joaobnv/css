...
- _Logic and Structure_ by Dirk Van Dalen.
- _Mathematical Logic_ by Heinz-Dieter Ebbinghaus, Jörg Flum, and Wolfgang Thomas.

# Abstract Algebra

## Books

- _Undergraduate Algebra_ by Serge Lang.
...
- _Engineering a Compiler_ by Keith Cooper, and Linda Torczon.

# Database Fundamentals

## Books

- _Sistemas de Gerenciamento de Banco de Dados_ by Raghu Ramakrishnan, and Gehrke.
...
- _Redes Ópticas de Acesso em Telecomunicações_ by José Maurício dos Santos Pinheiro.
...
- _Introduction to Static Analysis An Abstract Interpretation Perspective_ by Xavier Rival, and Kwangkeun Yi.
...
- _Head First Design Patterns_ by Eric Freeman, Elisabeth Robson, Bert Bates, and Kathy Sierra.

# Algebra

## Books

- _Quaternion Algebras_ by John Vaight.

# Mobile App Development

## Books

- _Use a Cabeça Desenvolvimento para Android_ by Dawn Griffiths, and David Griffiths.

# Programming

## Books

- _Advanced Programming in the UNIX Environment_ by Richard Stevens, and Stephen Rago.

# Software Documentation

## Books

- _The Latex Companion_ by Frank Mittelbach, and Michel Goossens.
